...
public class SectionFinishStop {
    ...
    public SectionFinishStop withCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public SectionFinishStop withStreet(String street) {
        this.street = street;
        return this;
    }
    ...
    public SectionFinishStop withStopDepartureTime(String stopDepartureTime) {
        this.stopDepartureTime = stopDepartureTime;
        return this;
    }
    ...
    public SectionFinishStop withStopArrivalTime(String stopArrivalTime) {
        this.stopArrivalTime = stopArrivalTime;
        return this;
    }
    ...
    public SectionFinishStop withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public SectionFinishStop withInformations(Object informations) {
        this.informations = informations;
        return this;
    }
    ...
    public SectionFinishStop withLng(String lng) {
        this.lng = lng;
        return this;
    }
    ...
    public SectionFinishStop withLat(String lat) {
        this.lat = lat;
        return this;
    }
    ...
    public SectionFinishStop withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public SectionFinishStop withCompany(Object company) {
        this.company = company;
        return this;
    }
    ...
    public SectionFinishStop withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public SectionFinishStop withDate(String date) {
        this.date = date;
        return this;
    }

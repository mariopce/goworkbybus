...
public class SectionStartStop {
    ...
    public SectionStartStop withCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public SectionStartStop withStreet(String street) {
        this.street = street;
        return this;
    }
    ...
    public SectionStartStop withStopDepartureTime(String stopDepartureTime) {
        this.stopDepartureTime = stopDepartureTime;
        return this;
    }
    ...
    public SectionStartStop withStopArrivalTime(String stopArrivalTime) {
        this.stopArrivalTime = stopArrivalTime;
        return this;
    }
    ...
    public SectionStartStop withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public SectionStartStop withInformations(Object informations) {
        this.informations = informations;
        return this;
    }
    ...
    public SectionStartStop withLng(String lng) {
        this.lng = lng;
        return this;
    }
    ...
    public SectionStartStop withLat(String lat) {
        this.lat = lat;
        return this;
    }
    ...
    public SectionStartStop withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public SectionStartStop withCompany(Object company) {
        this.company = company;
        return this;
    }
    ...
    public SectionStartStop withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public SectionStartStop withDate(String date) {
        this.date = date;
        return this;
    }
